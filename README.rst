...
3. visualizing aggregated traffic data, and
4. building bi-directional graph between municipalities and mapping
...
pandas dataframes with the filenaming convention `fin_traffic_raw_<begin-date>_<end_date>.pd.h5`.
