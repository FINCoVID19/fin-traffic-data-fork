...
def _aggregate_core(tms_num, t_begin, t_end, delta_t, raw_data_files) -> pd.DataFrame:
...
class Engine:
    ...
    def __call__(self, tms_num):
        _aggregate_core(tms_num, self.time0, self.time_end, self.delta_t, self.raw_data_files)
